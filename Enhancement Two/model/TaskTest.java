...
class TaskTest {
	...
	//ENHANCEMENT BELOW
	//Test immutable taskID
	@DisplayName("Test taskID is immutable")
	@Test
	void testTaskIDImmutability() {
	    ...
	    // Confirm ID is set correctly
	    assertEquals("1", tempTask.getTaskID());

	    // Uncommenting below should cause error if taskID is immutable:
	    // tempTask.setID("2");

	    // Confirm taskID remains unchanged
	    assertEquals("1", tempTask.getTaskID());
	}
