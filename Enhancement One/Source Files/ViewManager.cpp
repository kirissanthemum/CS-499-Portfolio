...
{
	//call camera.h method for mouse scroll
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	//change to different projection views
	if (glfwGetKey(m_pWindow, GLFW_KEY_O) == GLFW_PRESS)
	{
		bOrthographicProjection = true; //orthographic projection when O pressed

		//front view orthographic view
	...
	{
		bOrthographicProjection = false; //change to perspective projection
